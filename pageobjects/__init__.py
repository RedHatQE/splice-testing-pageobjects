...
locators = {
    ...
    "filters.filter.base.close_link": lambda : SE.find_element_by_xpath("//a[@class='close' and @href='#' and @data-close='panel' and text() = 'Close']"),
    ...
    "filters.new": lambda : SE.find_element_by_xpath("//a[@id='new' and @data-ajax_url='/sam/splice_reports/filters/new']"),
    "filters.new.selected": lambda : SE.find_element_by_xpath("//h2[@title='New Filter']"),
    "filters.new.name": lambda : SE.find_element_by_xpath("//input[@id='splice_reports_filter_name']"),
